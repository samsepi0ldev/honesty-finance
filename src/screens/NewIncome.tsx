...
import { View, Text, TextInput, TouchableOpacity, TouchableWithoutFeedback, Image as ImageComponent, StatusBar, Image } from 'react-native'
...
export function NewIncome () {
  ...
  useEffect(() => {
    StatusBar.setBackgroundColor('#00A86B')
